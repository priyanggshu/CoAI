...
export const saveUserQueryController = async (req, res) => {        // function to save user queries
...
export const getRecommendationsController = async (req, res) => {       // Function to generate recommendations
...
const generateTopicSuggestions = (queries) => {     // generates topic suggestions based on queries
  let suggestions = [];
