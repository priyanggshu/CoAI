    ...
    <div className="Oauth">
        {authDialogOpen ? (
            <div 
              ...
              <div className={`bg-gradient-to-br from-black/90 via-gray-900 to-black/90 border border-gray-900 rounded-2xl shadow-xl w-xl h-3/7 p-4 text-center scale-95 opacity-0 transition-all duration-300 ${
            ...
            onClick={(e) => e.stopPropagation()}
              >
                ...
                <div className="my-16">
                  ...
                  <button className="w-60 h-12 px-4 rounded-3xl flex gap-5 mx-auto items-center justify-center bg-gradient-to-r from-gray-800 hover:from-gray-900 to-blue-500/30 border-x border-gray-700 hover:border-gray-800">
